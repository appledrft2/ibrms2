...
class CreateJudicialRespondentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('judicial__respondents', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('judicial__respondents');
    }
}
