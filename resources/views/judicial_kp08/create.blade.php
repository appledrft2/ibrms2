...
<div class="box">
   <form action="/judicial/{{$judicial->id}}/kp08" method="POST" >
    ...
    <div class="box-header form-inline">
        <p>Case Details | Case No.: <input type="text" name="caseno" class="form-control"  readonly value="{{$judicial->caseno}}"> | KP Form No.: <input name="kpformno" type="text" class="form-control"  readonly value="KP08-{{date('y').'-'.date('mdHis')}}"></p>
    </div>
    <div class="box-body">
    	<div class="row">
    		<div class="col-md-6">
    ...
    <div class="pull-right">
        ...
        <button type="submit" class="btn btn-success"><i class="fa fa-plus-circle"></i> Add KP08</button>
    </div>
</form>
</div>
@endsection