...
<div class="card">
   <form action="/judicial/{{$resident->id}}/kp08" method="POST" >
        @csrf
        <input type="hidden" name="judicial_id" value="{{$resident->id}}">
    <div class="card-header form-inline">
        <p>Clearance Details | Resident Clearance ID No.: <input type="text" name="caseno" class="form-control"  readonly value="RBC-{{date('y').'-'.date('mdHis')}}">
    </div>
    <div class="card-body">
    	<div class="row">
    		<div class="col-6">
            ...
            <div class="col-6">
                <div class="form-group">
    				<label>Address <span class="req">*</span></label>
                    <textarea class="form-control" name="address" cols="5" rows="5" name="purpose" ></textarea>    
                </div>
                <div class="form-group">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <input  type="date" class="form-control" name="ornum" readonly value="{{ date('Y-m-d')}}">
                        </div>
                    </div>
                    <div class="col-6">
                        <?php 
                        ...
                        <input  type="date" class="form-control" name="ornum" value="{{$addmonth}}" readonly>
                        </div>
                    </div>
                </div>
            </div>
