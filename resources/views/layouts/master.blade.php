      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview @if($title=='Settings') active @else  @endif navs-items ">
          ...
          <ul class="treeview-menu " >
            ...
            <li><a class="@if($header=='Lupon') text-black @endif" @if($brgy) href="/lupon" @else href="#"@endif  style="margin-left:20px"><i class="fa fa-angle-double-right"></i> Lupon @if(!$brgy) (Setup brgy first) @endif</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
